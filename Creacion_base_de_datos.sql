...
INSERT INTO personas (Persona_ID, Nombre, Apellido, Telefono, Email) VALUES
    -- Agentes
    ('PER001', 'Ludy',    'Monsalve',    '3101001001', 'ana.gomez@inm.co'),
    ('PER002', 'omar',  'pinto',     '3101001002', 'pedro.ruiz@inm.co'),
    ('PER003', 'samuel',  'javier',   '3101001003', 'laura.castro@inm.co'),
    ('PER004', 'ana', 'maria',   '3101001004', 'miguel.ortega@inm.co'),
    ('PER005', 'maricela', 'rodriguez',     '3101001005', 'sandra.vega@inm.co'),
    -- Clientes
